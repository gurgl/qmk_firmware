...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_5x6(
     ...
     _______,_______,_______,KC_LBRC,KC_RBRC,KC_LBRC,                        KC_NUBS, KC_P7 , KC_P8 , KC_P9 ,KC_PLUS,KC_NUBS,
     RESET  ,_______,_______,KC_LPRN,KC_RPRN,KC_LPRN,                        KC_NUHS, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_QUOT,
     KC_PIPE,_______,_______,KC_LCBR,KC_LCBR,_______,                        KC_EQL , KC_P1 , KC_P2 , KC_P3 ,KC_EQL ,KC_UNDS,
