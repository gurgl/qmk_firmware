...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                      KC_DOWN,KC_UP  ,                                                       KC_LEFT,KC_RGHT,
                                      ...
                                      KC_LCTL,KC_LSFT,                        KC_SFTENT, KC_RCTL,
  ...
  [_LOWER] = LAYOUT_5x6(
     ...
     KC_TILD,RALT(KC_1),RALT(KC_2),KC_DLR ,RALT(KC_4),RALT(KC_5),                        KC_CIRC,KC_AMPR,KC_ASTR,KC_LPRN,KC_RPRN,KC_DEL,
     ...
     KC_PIPE,_______,_______,RALT(KC_7),RALT(KC_0),_______,                        KC_EQL , KC_P1 , KC_P2 , KC_P3 ,KC_EQL ,KC_UNDS,
                     _______,KC_PSCR,                                                              ALT_TAB, KC_P0 ,
                                             _______,KC_BSPC,                      _______,  RAISE,
  ...
  [_RAISE] = LAYOUT_5x6(
       ...
       KC_RBRC,KC_MNXT,KC_NLCK,KC_LALT ,KC_SLCK,KC_MUTE,                      KC_PGUP,LCTL(KC_C),KC_UP  ,LCTL(KC_V),_______,_______,
       KC_RPRN,KC_MPLY,KC_INS ,KC_LCTL,LCTL(KC_LSFT),KC_VOLD,                 KC_PGDN,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,
